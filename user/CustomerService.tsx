    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.subtitle}>
          ...
          menghubungi kontak CS kami melalui  
        ...
        <Text style={styles.subtitle}>
          Setiap hari pukul 07.00 hingga 23.00,  
          kecuali tanggal merah/hari libur internasional.
        </Text>

        <Text style={[styles.title, { marginTop: 32 }]}>Informasi Penting</Text>
        <Text style={styles.subtitle}>
          Kesalahan input data tidak dapat direfund,  
          pastikan kembali data sudah benar sebelum  
          bertransaksi.
        </Text>
      </View>
    </SafeAreaView>
